...
<script src="${pageContext.request.contextPath}/resources/js/component/registrationPopUp.js" type="text/javascript"></script>
...
<div class="signUp">
    ...
    <div class="input-information">
        <form class="input-form">
            ...
            <button class="signU buttonSignUp">Sign up</button>
        </form>
    </div>
</div>