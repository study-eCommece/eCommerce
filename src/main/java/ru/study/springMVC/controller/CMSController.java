...
public class CMSController {
	...
	public String getTest() {
		return "<p>Protection of personal data when processing them in an information system that neutralizes the relevance, in accordance with Part 5 of Articles 19 of the Federal Law \"On Personal Data\".</p>\n" +
